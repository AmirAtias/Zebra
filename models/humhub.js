...
db.once('open', async function crawler() {
    const socialMedia = "humhub"
    var url = "https://guyandamir-sn.humhub.com/u/guyamir/"
    var username = "guyhmhubbbbbb"
    try {
      ...
      //init login data
      //element =  await driver.findElement(By.xpath('//*[@id="h804986w3"]'));
      //await element.click();

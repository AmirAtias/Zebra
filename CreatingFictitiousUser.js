...
// make a connection
mongoose.connect("mongodb://localhost:27017/fictitiousUser", { useNewUrlParser: true ,   useUnifiedTopology: true });
...
var newUserModel = mongoose.model('newUsersWorldExplorer',newUserSchema);
...
db.once('open', async function() {
  try {
          ...
          var newUser = new newUserModel({
            ...
            // save schema to db
            await newUser.save(function (err, newUserModel) {

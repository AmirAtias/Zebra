...
router.get('/', function (req, res, next) {
  ...
  async function main() {
    ...
    for( pr of facebookCrawler.posts){
      console.log(pr.postHeader)
      console.log(pr.postContent)
      for(p of pr.postContent)
      console.log(p);
    }
    res.send(facebookCrawler);
  }
